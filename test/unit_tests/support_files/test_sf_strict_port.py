...
//     """ f'{namespace_prefix}' """Dzn::Mts<IMyService> strictMtsPort{m_dznPort};
//     """ f'{namespace_prefix}' """Dzn::Sts<IMyService> strictStsPort{m_dznPort};
//
// return a strict 'STS' port as function return:
//
//     """ f'{namespace_prefix}' """Dzn::Sts<IMyService> GetStrictPort()
//     {
//        return {m_dznPort};
//     }
//
...
//
//     """ f'{namespace_prefix}' """Dzn::ConnectPorts( strictStsPort, GetStrictPort() ); // Ok
//     """ f'{namespace_prefix}' """Dzn::ConnectPorts( strictMtsPort, GetStrictPort() ); // Error, during compilation
//
//
...
DEFAULT_DZN_STRICT_PORT_HH = template_strict_port_hh('')
MYNAMESPACE_DZN_STRICT_PORT_HH = template_strict_port_hh('My::Name::Space::')
