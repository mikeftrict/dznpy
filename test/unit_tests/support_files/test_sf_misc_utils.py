...
def template_misc_utils_hh(namespace_prefix: str) -> str:
    return """\
...
DEFAULT_DZN_MISC_UTILS_HH = template_misc_utils_hh('')
PROJECT_DZN_MISC_UTILS_HH = template_misc_utils_hh('Project::')
