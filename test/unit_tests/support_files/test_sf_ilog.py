...
def template_ilog_hh(namespace_prefix: str) -> str:
    return """\
// Logging Interface
//
...
// Example 1:
//
//     """ f'{namespace_prefix}' """Dzn::ILog logger1 = {
...
// Example 2:
//
//     """ f'{namespace_prefix}' """Dzn::ILogWithContext logger2("MyContext", logger1);
...
DEFAULT_DZN_ILOG_HH = template_ilog_hh('')
MYPROJECT_DZN_ILOG_HH = template_ilog_hh('MyProject::')
