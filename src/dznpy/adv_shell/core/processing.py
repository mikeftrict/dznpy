...
def create_cpp_portitf(dzn: DznPortItf, scope: cpp_gen.Struct, support_files_ns: NamespaceIds,
    ...
    def sts():
        # pass-through mode
        strict_port = TypeDesc(Fqn(support_files_ns + ns_ids_t('Sts'), True), TemplateArg(typ.fqname))
        member_var = None
    ...
    def mts_plain():
        ...
        strict_port = TypeDesc(Fqn(support_files_ns + ns_ids_t('Mts'), True), TemplateArg(typ.fqname))
